...
const labels: Record<string,string> = { pending: "未承認", reviewing: "検討中", rejected: "拒否", approved: "入会済", withdrawn: "退会済み" };
